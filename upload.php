...
if (is_file(__DIR__ . '/upload_gc.php')) { if (is_file(__DIR__ . '/upload_gc.php')) { require_once __DIR__ . '/upload_gc.php'; } }
if (!is_dir($uploadDir)) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (function_exists('aspiCleanupUnreferencedUploads')) { if (function_exists('aspiCleanupUnreferencedUploads')) { aspiCleanupUnreferencedUploads(); } }
